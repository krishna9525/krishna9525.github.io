...
const Navbar = () => {
  ...
  return (
    ...
    <div>
      <h1 className="font-signature text-4xl">Krishna</h1>
    </div>
    ...
    <li key={id} className='px-3 cursor-pointer font-medium capitalize text-gray-500 hover:scale-125 duration-200'>
      ...
      <a href="./resume.pdf" className=' flex justify-between items-center w-full px-3 cursor-pointer font-medium capitalize text-gray-500 hover:scale-125 duration-200' download target="_blank" rel='noreferrer'>
                    Resume
                </a>
...
{nav && (
     ...
     {links.map(({id,link,title})=>( 
       ...
       <a href="./resume.pdf" className='text-4xl px-4 py-4 cursor-pointer capitalize text-gray-400 ' download target="_blank" rel='noreferrer'>
                    Resume
                </a>
